...
redirect_from:
- /system/everrun/high-availability/2026/04/08/everrun-7.9-ft-vm.html
---

HA thường vẫn có downtime: node chết, VM khởi động lại ở node khác. Lab dựng Stratus EverRun 7.9.4.1 cluster 2 node trên VMware ESXi và tạo VM ở chế độ Fault Tolerant — VM chạy đồng thời trên cả hai node vật lý, mất một node thì dịch vụ không gián đoạn một giây nào.
