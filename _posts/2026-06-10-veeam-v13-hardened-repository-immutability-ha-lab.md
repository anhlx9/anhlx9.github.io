...
## Mục lục
- [Mục lục](#mục-lục)
  - [1. Topology và Lab Design](#1-topology-và-lab-design)
  - [2. Chuẩn bị Linux Hardened Repository](#2-chuẩn-bị-linux-hardened-repository)
  - [3. Cài đặt Veeam VBR 13](#3-cài-đặt-veeam-vbr-13)
  - [4. Add Repository và Immutability](#4-add-repository-và-immutability)
  - [5. Add vCenter và Protection Group](#5-add-vcenter-và-protection-group)
...
### 4. Add Repository và Immutability
...
### 5. Add vCenter và Protection Group
